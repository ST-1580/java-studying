...
public class CheckedMultiply implements TripleExpression, ExpressionD, ExpressionBi, ExpressionS, ExpressionU, ExpressionL {
    ...
    public CheckedMultiply (ExpressionD firstD, ExpressionD secondD) {
        this.firstD = firstD;
        this.secondD = secondD;
    }

    public CheckedMultiply (ExpressionBi firstBi, ExpressionBi secondBi) {
        this.firstBi = firstBi;
        this.secondBi = secondBi;
    }

    public CheckedMultiply (ExpressionS firstS, ExpressionS secondS) {
        this.firstS = firstS;
        this.secondS = secondS;
    }

    public CheckedMultiply (ExpressionL firstL, ExpressionL secondL) {
        this.firstL = firstL;
        this.secondL = secondL;
    }

    public CheckedMultiply (ExpressionU firstU, ExpressionU secondU) {
        this.firstU = firstU;
