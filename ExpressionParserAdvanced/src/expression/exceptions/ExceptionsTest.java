...
public class ExceptionsTest extends ParserTest {
    ...
    public static final TripleExpression VX = new Variable("x");
    public static final TripleExpression VY = new Variable("y");
    ...
    protected static void testOverflow() {
        ...
        testOverflow((a, b) -> -b, "<- ignore first argument, unary -", new CheckedMinus(VY));
    }
